...
export const selfIntroduction =
  '我毕业于华南理工大学。在校期间，我的研究方向主要有无线网络的能量充电和无线传感网络的资源调度分配。毕业后，我在世界500强的制造业和互联网企业工作，主要聚焦企业级前端技术落地与业务价值交付，核心围绕「纵向业务平台建设」与「横向跨团队技术复用」两大方向深耕，积累了从技术方案设计到规模化落地的全流程经验。未来我将演进全栈和AI方向的能力，专注于为企业及客户创造极速、稳定且具备商业价值的数字产品。'

export const selfIntroductionEn =
  `I graduated from South China University of Technology. During my time at university, my research interests included energy charging for wireless networks and resource scheduling allocation for wireless sensor networks. 
